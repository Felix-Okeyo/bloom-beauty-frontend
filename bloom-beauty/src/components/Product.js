        ...
        <div class="lg:flex lg:items-start">
          <div class="lg:order-2 lg:ml-5">
            <div class="max-w-xl overflow-hidden rounded-lg">
              <img class="h-full w-full max-w-full object-cover" src="/Users/crystalmuthoni/bloom-beauty-frontend/bloom-beauty/img/pexels-photo-2639947.jpeg" alt="" />
            </div>
          </div>
          ...
          <div class="mt-2 w-full lg:order-1 lg:w-32 lg:flex-shrink-0">
            <div class="flex flex-row items-start lg:flex-col">
              <button type="button" class="flex-0 aspect-square mb-3 h-20 overflow-hidden rounded-lg border-2 border-gray-900 text-center">
                <img class="h-full w-full object-cover" src="/Users/crystalmuthoni/bloom-beauty-frontend/bloom-beauty/img/pexels-photo-2639947.jpeg" alt="" />
              </button>
