...
function Contact(){
    return (
      <>
      <section class="bg-brown-50 dark:bg-brown-800" id="contact">
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        <div class="mb-4">
            <div class="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                {/* <p class="text-base font-semibold uppercase tracking-wide text-black-600 dark:text-black-200">
                    Contact
                </p> */}
                <h2
                    ...
                    <ul class="mb-6 md:mb-0">
                        ...
                        <li class="flex">
                            ...
                            <div class="ml-4 mb-4">
                                ...
                                <p class="text-gray-600 dark:text-slate-400">Mobile: +254 12345678</p>
                                <p class="text-gray-600 dark:text-slate-400">Mail: bloombeauty@gmail.com</p>
                            </div>
                        </li>
                        <li class="flex">
                            <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
