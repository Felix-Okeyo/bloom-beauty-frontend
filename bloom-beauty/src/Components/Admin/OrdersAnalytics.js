    ...
    axios.get('https://bloom-beauty.onrender.com/invoices')
      .then((response) => {
        ...
        const categoryData = categories.map(category => {
          ...
          const totalQuantity = invoiceData
            ...
            .reduce((total, invoice) => {
              ...
              if (!isNaN(quantity)) {
                ...
                console.log("Invalid quantity for product:", invoice);
                return total;
              }
            }, 0);
          ...
          const totalPrice = invoiceData
            .filter(invoice => invoice.category === category)
            .reduce((total, invoice) => total + invoice.cost, 0);
